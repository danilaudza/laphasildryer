...
import { addMesin, updateField } from "../Redux/Slices/FieldSlices";
...
const MultiField2 = () => {
  ...
  useEffect(() => {
    dispatch(addMesin(payload))
    dispatch(updateField({ id: inputFields.id, updatedInputFields: updatedFields }));
  },[])
